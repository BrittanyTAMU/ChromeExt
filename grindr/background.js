...
chrome.runtime.onInstalled.addListener((details) => {
  console.log('MatchGuard for Grindr installed:', details.reason);
...
chrome.tabs.onUpdated.addListener((tabId, changeInfo, tab) => {
  if (changeInfo.status === 'complete' && tab.url && tab.url.includes('grindr.com')) {
...
chrome.action.onClicked.addListener((tab) => {
  if (tab.url && tab.url.includes('grindr.com')) {
